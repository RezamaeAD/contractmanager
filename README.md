...
This CAP project and included SAP Fiori application was generated with the Project Accelerator, using the prompt 'I want to create an SAP Fiori application that satisfies the requirements from the following user story:
